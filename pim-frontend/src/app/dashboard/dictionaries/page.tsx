          ...
          return (
            <div key={t.id} className="rounded-lg border bg-white p-4 shadow">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-600">
                <div className="rounded border p-2"><div className="text-[11px] uppercase text-gray-400">Елементів</div><div className="text-base font-semibold">{total}</div></div>
                <div className="rounded border p-2"><div className="text-[11px] uppercase text-gray-400">Корені</div><div className="text-base font-semibold">{roots}</div></div>
                <div className="rounded border p-2"><div className="text-[11px] uppercase text-gray-400">Зв'язків</div><div className="text-base font-semibold">{linksCount}</div></div>
                <div className="rounded border p-2"><div className="text-[11px] uppercase text-gray-400">Cover</div><div className="text-base font-semibold">{coverCount}</div></div>
                <div className="rounded border p-2 col-span-2"><div className="text-[11px] uppercase text-gray-400">Мови</div><div className="text-sm">{langs.count} {langs.def ? `(дефолт: ${langs.def})` : ''}</div></div>
              </div>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                <Link href={`/dashboard/dictionaries/groups/tree?type=${encodeURIComponent(t.id)}`} className="rounded border px-3 py-1 text-xs">Дерево</Link>
                {!hasRoot.get(t.id) && (
